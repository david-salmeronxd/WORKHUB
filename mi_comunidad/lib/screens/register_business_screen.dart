...
class _RegisterBusinessScreenState extends State<RegisterBusinessScreen> {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      final saved = await BusinessService.addBusiness(newBusiness);
      if (!mounted) return;
      if (saved == null) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('No se pudo guardar el negocio')));
        return;
      }
